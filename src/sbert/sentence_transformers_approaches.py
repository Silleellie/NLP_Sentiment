...
class ClusteringApproach(Approach):
    """
    Class that models the supervised clustering approach of the embeddings generated by SBERT
...
class MLPApproach(Approach):
    """
    Class that models the MLP approach to classify the embeddings generated by SBERT
